...
public class EmailService {
    ...
    public void sendEmail(String receiver, String code, String type) throws MessagingException, UnsupportedEncodingException {
        MimeMessage message = javaMailSender.createMimeMessage();
        message.setRecipients(Message.RecipientType.TO, receiver);
        message.setSubject("StockBurning " + type + " 인증코드");
